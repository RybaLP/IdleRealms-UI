  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row gap-6 mt-8">
          ...
          <Link href="/login" 
            className="px-12 py-4 bg-linear-to-b from-blue-500 to-blue-700 text-white font-bold rounded-md border-b-4 border-blue-900 hover:brightness-125 hover:scale-105 active:border-b-0 active:translate-y-1 transition-all duration-200 uppercase tracking-wider min-w-[200px] text-center shadow-lg shadow-blue-900/20">
            Log In
          </Link>
